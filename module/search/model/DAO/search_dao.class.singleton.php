<?php
    class search_dao {
        ...
        function select_data_brand_type($db, $type){
        ...
        function select_data_autocomplete($db, $args){
            $sql = "SELECT DISTINCT c.name_cities
					FROM cities c
					WHERE c.name_cities LIKE '$args%'";
        ...
        function select_data_autocomplete_brand($db, $brand, $auto){
        ...
        function select_data_autocomplete_type($db, $type, $auto){
        ...
        function select_data_autocomplete_type_brand($db, $auto, $type, $brand){
            $sql = "SELECT DISTINCT b.name_brand, c.name_cities
                    FROM brands b 
