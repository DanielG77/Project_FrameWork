function protecturl() {
    ...
    ajaxPromise('/programas/courses_home/module/auth/controller/ctrl_auth.php?op=controluser', 'POST', 'JSON', { 'token': token })
        .then(function(data) {
...
function control_activity() {
    var token = localStorage.getItem('token');
    if (token) {
        ajaxPromise('/programas/courses_home/module/auth/controller/ctrl_auth.php?op=actividad', 'POST', 'JSON')
...
function refresh_token() {
    var token = localStorage.getItem('token');
    if (token) {
        ajaxPromise('/programas/courses_home/module/auth/controller/ctrl_auth.php?op=refresh_token', 'POST', 'JSON', { 'token': token })
...
function refresh_cookie() {
    ajaxPromise('/programas/courses_home/module/auth/controller/ctrl_auth.php?op=refresh_cookie', 'POST', 'JSON')
        .then(function(response) {
